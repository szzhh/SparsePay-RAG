#!/usr/bin/env python3
"""
SparsePay-RAG generation script for ChatDoctor.
...
def main():
    parser = argparse.ArgumentParser(
        description="SparsePay-RAG generation for ChatDoctor"
    )
    ...
    parser.add_argument("--gold_path", required=True,
                        help="Path to gold answers (JSON with 'output' field).")
    ...
    parser.add_argument("--em_temperature", type=float, default=1.2,
    ...
    result = evaluate(args.gold_path, pred_path, metric="bertscore")
